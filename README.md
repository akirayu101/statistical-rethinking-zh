...
- `config/chapter-contracts.json` 锁定第 1–11 章整章及第 12 章当前译稿的页码、锚点、标题和组件数量；只有满足契约才能保持相应进度状态。
...
- 第 12 章 PDF 第 397–405 页已达到页面级 `verified`；零膨胀 Poisson likelihood 与代码 12.7 从 PDF 第 406 页继续。
- 全书累计完成 11/17 章、验收 389/617 个 PDF 页面。
