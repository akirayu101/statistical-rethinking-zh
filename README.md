...
- `config/chapter-contracts.json` 锁定第 1–8 章整章及第 9 章当前译稿的页码、锚点、标题和组件数量；只有满足契约才能保持相应进度状态。
...
- 第 9 章 PDF 第 285–320 页已完成翻译、逐页核对与桌面/移动端验收，达到页面级 `verified`；下一批从 PDF 第 321 页继续。
- 全书累计完成 8/17 章、验收 304/617 个 PDF 页面。
