...
- `config/chapter-contracts.json` 锁定第 1–10 章整章及第 11 章当前译稿的页码、锚点、标题和组件数量；只有满足契约才能保持相应进度状态。
...
- 第 12 章 PDF 第 397–402 页已达到页面级 `verified`；12.1.3 与图 12.2 从 PDF 第 403 页继续。
- 全书累计完成 11/17 章、验收 386/617 个 PDF 页面。
