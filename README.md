...
- `config/chapter-contracts.json` 锁定第 1–9 章整章及第 10 章当前译稿的页码、锚点、标题和组件数量；只有满足契约才能保持相应进度状态。
...
- 第 10 章 PDF 第 323–341 页已达到页面级 `verified`；下一批从 PDF 第 342 页继续。
- 全书累计完成 9/17 章、验收 325/617 个 PDF 页面。
