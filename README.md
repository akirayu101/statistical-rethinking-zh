...
- `config/chapter-contracts.json` 锁定第 1–8 章当前译稿的页码、锚点、标题和组件数量；只有满足契约才能保持相应进度状态。
...
- 第 8 章 PDF 第 257–265 页已完成翻译、逐页核对和桌面/移动端验收；本章继续从 PDF 第 266 页翻译。
- 全书累计完成 7/17 章、验收 249/617 个 PDF 页面。
